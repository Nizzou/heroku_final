...
module.exports = {
    ...
    async execute(client, interaction) {
        ...
        if (!interaction.member.permissions.has([cmd.permissions])) 
            return interaction.reply({ content: `Vous n'avez pas la/les permission(s).\nSi vous avez besoin d'aide, mentionnez un ${modo} !`, ephemeral: true});
